...
| CISOBUS.cs | 180 | Protocolo ISOBUS para secciones | ~~FormGPS~~ invertida con `IIsobusHost` (SendPgnToLoop + botón UI) — **movida a Core 2026-07-17** | PORTABLE |
