...
|---|---|---|---|---|
| 1 | Extraer core a librería sin UI | AVANZADO | ~40% | ~14 clases de Classes/ acopladas a `FormGPS` por constructor (CNMEA, CISOBUS…; CAHRS/CDubins/CFieldData/CModuleComm/CTram/CSim/CBoundary(+CFence/CTurn/CHead)/CSection/CPatches/CTool/CVehicle/CABLine/CABCurve/CContour/CGuidance/CYouTurn/CTrack/CRecordedPath ya movidas) → interfaces estilo `FormGps*Service`; y el parsing NMEA/PGN de AgIO (NMEA.Designer, PGN.Designer, UDP) |
