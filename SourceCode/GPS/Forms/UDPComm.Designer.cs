...
namespace AgOpenGPS
{
    public partial class FormGPS
    {
        ...
        // Parser de PGNs entrantes (vive en Core; el form conserva sockets+UI).
        // Se instancia en el constructor de FormGPS junto a isobus.
        public PgnReceiver pgnReceiver;

        // Compat: consumidores existentes (FormGPSData, StateProvider, log de
        // cierre, LoadSettings) siguen leyendo/escribiendo por estos nombres.
        public int missedSentenceCount => pgnReceiver.MissedSentenceCount;

        public int udpWatchLimit
        {
            get => pgnReceiver.UdpWatchLimit;
            set => pgnReceiver.UdpWatchLimit = value;
        }

        //El parseo vive en Core (Protocols/PgnReceiver.cs) — traspaso
        //portabilidad 2026-07-19. Este wrapper queda porque ReceiveAppData
        //lo invoca vía BeginInvoke en el hilo de UI.
        private void ReceiveFromAgIO(byte[] data)
        {
            pgnReceiver.ReceiveFromAgIO(data);
        }
