...
namespace AgroParallel.VistaX
{
    public class VistaXFieldLogger : IDisposable
    {
        ...
        public VistaXFieldLogger(FormGPS parent, VistaXConfig config)
        {
            _parent = parent;
            _config = config;
        }
        ...
        {
            try { return _parent != null ? _parent.currentFieldDirectory : null; }
            catch { return null; }
        }
        ...
        private string GetFieldFullPath()
        {
            try
            {
                ...
                string name = _parent.currentFieldDirectory;
                if (string.IsNullOrEmpty(name)) return null;
                if (string.IsNullOrEmpty(RegistrySettings.fieldsDirectory)) return null;
                return Path.Combine(RegistrySettings.fieldsDirectory, name);
            }
            catch { return null; }
        }
