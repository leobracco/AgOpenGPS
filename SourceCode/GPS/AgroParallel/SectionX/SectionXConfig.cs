...
// Mapeo explícito: cada cable del nodo → sección AOG.
// ============================================================================
...
{
    // Mapeo de un cable físico del PCA9685 a una sección AOG.
    public class SxCableMap
    {
        ...
        // Sección AOG que controla (1-based, 0 = no asignado).
    ...
    public class SectionXConfig
    {
        ...
        [JsonPropertyName("vel_minima")]
        public double VelMinima { get; set; }
