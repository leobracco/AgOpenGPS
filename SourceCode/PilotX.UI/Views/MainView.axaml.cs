    ...
    public partial class MainView : UserControl
    {
        ...
        private bool RouteCockpitCommand(string cmd)
        {
            ...
            string? page = cmd switch
            {
                ...
                // "cabecera" y "cabecera_avanzada" se quedan en HTML EN ESTA
                // SUPERFICIE a propósito: MainView es la vista alternativa/
                // Android y no tiene los hosts flotantes de MainWindow
                // (CabeceraHost y CabeceraLineasHost viven en MainWindow.axaml).
                // En la cabina (MainWindow) los dos comandos abren panel NATIVO.
