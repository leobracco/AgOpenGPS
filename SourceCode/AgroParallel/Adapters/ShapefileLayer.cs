// ============================================================================
// ShapefileLayer.cs — capa de prescripcion (.shp) SIN dibujo.
//
// Antes vivia entera en el proyecto GPS (WinForms) con el Draw GL adentro: el
// motor headless no podia ni cargarla, asi que QuantiX/FlowX contra el motor
// recibian dosis 0 y el mapa de PilotX.Desktop no tenia que dibujar. Esta es
// la parte PORTABLE (proyeccion, triangulacion ear-clipping, dosis por
// point-in-polygon, colores por atributo); se LINKEA en AgOpenGPS.csproj y en
// PilotX.GuidanceEngine.csproj, misma convencion que TramLineMapper. El Draw
// GL quedo en GPS/AgroParallel/Common/ShapefileLayerDraw.cs (partial).
// ============================================================================
// ============================================================================
...
{
    public partial class ShapefileLayer : IShapefileExportSource
    {
        ...
        public void EnsureProjected(LocalPlane plane)
        {
