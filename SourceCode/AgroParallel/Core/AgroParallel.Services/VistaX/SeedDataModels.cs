...
namespace AgroParallel.VistaX
{
    ...
    // =========================================================================
    // Payload de secciones PilotX: sections/state
    // { "t1": [1,1,0,1,...], "t2": [1,1,1,...] }
    // =========================================================================
    ...
    public class SensorConfig
    {
        ...
        // Sección PilotX a la que pertenece (0 = auto-calcular por posición).
        [JsonPropertyName("seccion_aog")]
        public int SeccionAOG { get; set; }

        // Silenciado por el operario desde la UI. Cuando es true, el surco
        // que cubre este sensor no genera alarmas y se pinta en gris/muted.
        // Persistido en implemento.json (mapeo_sensores[].muted).
    ...
    public class ImplementoSetup
    {
        ...
        // Cantidad de secciones PilotX configuradas para este implemento.
        // Puede ser diferente de surcos y de sensores.
        // Ej: 43 surcos, 43 sensores, 2 secciones PilotX.
        [JsonPropertyName("secciones_aog")]
        public int SeccionesAOG { get; set; }

        // Ancho total del implemento en metros (leído de PilotX o manual).
        ...
        // Permite la vista "torres" del widget nativo y del HTML overlay:
        // muestra una celda por torre (promediando surcos) en lugar de N
        // celdas por surco. Mirror byte-idéntico de VistaXSetupDto.Torres.
        [JsonPropertyName("torres")]
        public int Torres { get; set; }

        // Surcos por torre. 0 = derivar ceil(TotalSurcos/Torres) en runtime.
        [JsonPropertyName("surcos_por_torre")]
        public int SurcosPorTorre { get; set; }

        // Vista inicial del widget: "surcos" | "torres". El operario puede
        // cambiarla en runtime (preferencia runtime se guarda aparte).
        [JsonPropertyName("vista_modo_default")]
        public string VistaModoDefault { get; set; }
        ...
        public ImplementoSetup()
        {
            ...
            FactorK = 0.15;
            VistaModoDefault = "surcos";
        }

        // Calcula qué surcos cubre la sección PilotX dada (1-based).
    ...
    public class SurcoState
    {
        ...
        // Datos para identificar el sensor físico que alimenta este surco
        // (uid + cable) — necesarios para silenciar desde la UI vía
        // POST /api/vistax/sensor/mute o doble-click sobre el tubo.
        public string Uid { get; set; }
        public int Cable { get; set; }

        // Objetivo de siembra (semillas/m) propagado desde el tren del surco.
        // Sirve a la UI para pintar el degradé negro→verde según ratio real/obj.
        public double Objetivo { get; set; }

        // Silenciado por el operario — copiado de SensorConfig.Muted.
        public bool Muted { get; set; }
    ...
    public class SeedMonitorSnapshot
    {
        ...
        // Layout de torres (vista agrupada del widget nativo).
        //   Torres=0           → no agrupar, vista clásica surco-por-surco.
        //   Torres>1           → habilita el toggle "S/T" en el widget; cada
        //                        torre agrupa SurcosPorTorre bajadas consecutivas.
        //   SurcosPorTorre=0   → derivar como ceil(TotalSurcos/Torres) en runtime.
        //   VistaModoDefault   → "surcos" | "torres" — modo inicial del widget
        //                        (después el operario puede tocar el toggle).
        public int Torres { get; set; }
        public int SurcosPorTorre { get; set; }
        public string VistaModoDefault { get; set; }
